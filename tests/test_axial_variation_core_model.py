...
def test_axial_variation_single_assembly_core_model():
    path_to_configs = GE14_CORE_YAML
    ...
    assert single_assembly_core_model.assembly_axial_layouts == {'single_GE14_assembly': [{'axial_region': 'DOM', 'axial_bounds': [0.0, 222.0595], 'assembly_geometry_file': '../ASSEMBLY/GEOM_GE14_DOM.yaml'}, {'axial_region': 'VAN', 'axial_bounds': [222.0595, 347.1291], 'assembly_geometry_file': '../ASSEMBLY/GEOM_GE14_VAN.yaml'}]}
    ...
    assert single_assembly_core_model.assemblies[(0, 0, "single_GE14_assembly")].slice_to_geometry_dict == {"2D_slice_geometry_for_DOM_region_of_single_GE14_assembly": "../ASSEMBLY/GEOM_GE14_DOM.yaml", "2D_slice_geometry_for_VAN_region_of_single_GE14_assembly": "../ASSEMBLY/GEOM_GE14_VAN.yaml"}
...
def test_axial_variation_4x4_minicore():
    ...
    assert minicore_model.assembly_axial_layouts['GE14_10%'] == [{'axial_region': 'DOM', 'axial_bounds': [0.0, 222.0595], 'assembly_geometry_file': '../ASSEMBLY/GEOM_GE14_DOM.yaml'}, {'axial_region': 'VAN', 'axial_bounds': [222.0595, 347.1291], 'assembly_geometry_file': '../ASSEMBLY/GEOM_GE14_VAN.yaml'}]
    assert minicore_model.assembly_axial_layouts['GE14_20%'] == [{'axial_region': 'DOM', 'axial_bounds': [0.0, 222.0595], 'assembly_geometry_file': '../ASSEMBLY/GEOM_GE14_DOM.yaml'}, {'axial_region': 'VAN', 'axial_bounds': [222.0595, 347.1291], 'assembly_geometry_file': '../ASSEMBLY/GEOM_GE14_VAN.yaml'}]
    assert minicore_model.assembly_axial_layouts['GE14_30%'] == [{'axial_region': 'DOM', 'axial_bounds': [0.0, 222.0595], 'assembly_geometry_file': '../ASSEMBLY/GEOM_GE14_DOM.yaml'}, {'axial_region': 'VAN', 'axial_bounds': [222.0595, 347.1291], 'assembly_geometry_file': '../ASSEMBLY/GEOM_GE14_VAN.yaml'}]
