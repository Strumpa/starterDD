...
GE14_DOM_C_GEOMETRY_YAML = str(GE14_INPUTS_DIR / "GEOM_GE14_DOM-C.yaml")
GE14_CALC_SCHEME_YAML = str(GE14_INPUTS_DIR / "CALC_SCHEME_GE14.yaml")
GE14_CALC_SCHEME_1L_YAML = str(GE14_INPUTS_DIR / "CALC_SCHEME_1L.yaml")
GE14_CALC_BRANCHES_YAML = str(GE14_INPUTS_DIR / "CALC_BRANCHES.yaml")
GE14_CALC_OUTPUTS_YAML = str(GE14_INPUTS_DIR / "CALC_OUTPUTS.yaml")
...
AT10_GEOMETRY_CTRL_YAML = str(AT10_INPUTS_DIR / "GEOM_ATRIUM10_CTRL.yaml")
